<template>
  <section>
    <router-link to="/">
      ...
      <a
        class="github-link"
        href="https://github.com/overly-engineered/chatter"
        target="_blank"
        alt="Go see this project on github"
        v-on:click="github"
        @keyup.enter="github"
      >
        <svg
        ...
        >
          <g id="XMLID_24_">
            <path
              id="XMLID_26_"
              class="st0"
              d="M250,72C149.2,72,67.5,153.7,67.5,254.5c0,80.6,52.3,149,124.8,173.2c9.1,1.7,12.5-4,12.5-8.8
		...
		C432.5,153.7,350.8,72,250,72z"
            ...
            <path
              id="XMLID_30_"
              class="st1"
              d="M136.6,334c-0.4,0.9-1.8,1.2-3.1,0.6c-1.3-0.6-2.1-1.8-1.6-2.7c0.4-0.9,1.8-1.2,3.1-0.6
		C136.3,331.9,137.1,333.1,136.6,334z"
            />
            <path
              id="XMLID_31_"
              class="st1"
              d="M144,342.3c-0.9,0.8-2.6,0.4-3.7-0.8c-1.2-1.3-1.4-3-0.5-3.8c0.9-0.8,2.5-0.4,3.7,0.8
		C144.7,339.8,144.9,341.5,144,342.3z"
            />
            <path
              id="XMLID_32_"
              class="st1"
              d="M151.2,352.8c-1.1,0.8-2.9,0.1-4.1-1.6c-1.1-1.6-1.1-3.6,0-4.4c1.1-0.8,2.9-0.1,4.1,1.5
		C152.4,350,152.4,352,151.2,352.8z"
            />
            <path
              id="XMLID_33_"
              class="st1"
              d="M161.1,362.9c-1,1.1-3.1,0.8-4.7-0.7c-1.6-1.5-2-3.6-1-4.7c1-1.1,3.2-0.8,4.7,0.7
		C161.7,359.8,162.1,361.9,161.1,362.9z"
            />
            <path
              id="XMLID_34_"
              class="st1"
              d="M174.7,368.8c-0.4,1.4-2.5,2.1-4.6,1.5c-2.1-0.6-3.4-2.3-3-3.7c0.4-1.4,2.5-2.1,4.6-1.5
		C173.7,365.7,175.1,367.4,174.7,368.8z"
            />
            <path
              id="XMLID_35_"
              class="st1"
              d="M189.6,369.9c0.1,1.5-1.7,2.8-3.9,2.8c-2.2,0.1-3.9-1.2-4-2.7c0-1.5,1.7-2.8,3.9-2.8
		C187.8,367.2,189.6,368.4,189.6,369.9z"
            />
            <path
              id="XMLID_36_"
              class="st1"
              d="M203.5,367.6c0.3,1.5-1.2,3-3.4,3.4c-2.1,0.4-4.1-0.5-4.3-2c-0.3-1.5,1.3-3,3.4-3.4
...
export default {
  methods: {
    github: () => {
      // @ts-ignore
      window.location = "https://github.com/overly-engineered/chatter";
    }
  }
};
</script>
